...
export const api = {
  ...
  extractionSources: () => failover(() => request<ExtractionSource[]>("/extraction/sources"), () => syntheticExtractionOptionsForTenant(sessionStorage.getItem("tenant") ?? "research-clinic")),
