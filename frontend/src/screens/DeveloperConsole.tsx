...
const PRESET_ENDPOINTS: Endpoint[] = [
  ...
  { method: "POST", path: "/api/v1/import", description: "Import deterministic demo documents or cohort data" , defaultBody: JSON.stringify({ importType: "database" }, null, 2) },
  { method: "GET", path: "/api/v2/health", description: "Fetch advanced system health checking database and storage connectivity" },
  { method: "GET", path: "/api/v2/mcp/tools", description: "Retired public MCP endpoint (returns 410)" },
  { method: "GET", path: "/api/v2/a2a/card", description: "Retired public A2A endpoint (returns 410)" },
];
