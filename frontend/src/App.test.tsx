...
describe("clinical product shell", () => {
  ...
  it("maps retired live sessions to the deterministic demo", () => {
  ...
  it("switches between deterministic demo tenants", async () => {
    localStorage.setItem("clinicalRole", "clinician");
    ...
    expect([...select.options].map(option => option.value)).toEqual(["research-clinic", "northstar-health"]);
