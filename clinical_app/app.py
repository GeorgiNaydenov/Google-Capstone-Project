...
def create_app() -> FastAPI:
    ...
    async def list_mcp_tools() -> dict[str, Any]:
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail=f"Failed to list MCP tools: {e}"
            )
    ...
    async def execute_mcp_tool(body: McpExecuteRequest, ctx: Context) -> dict[str, Any]:
        ...
        try:
            ...
            if body.tool_name == "query_clinical_database":
                ...
                if not safety["safe"]:
                    raise HTTPException(
                        status_code=400, detail=f"SQL Blocked: {safety['reason']}"
                    )
    ...
    def a2a_card() -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "instruction": root_agent.instruction[:500] + "..."
                if root_agent.instruction
                else None,
            ...
            raise HTTPException(
                status_code=500, detail=f"Failed to retrieve A2A card: {e}"
            )
