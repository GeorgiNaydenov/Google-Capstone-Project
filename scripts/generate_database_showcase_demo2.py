...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate second-platform database intelligence demo data."
    )
    ...
    parser.add_argument(
        "--anchor-date", type=date.fromisoformat, default=date(2026, 7, 5)
    )
    ...
    parser.add_argument(
        ...
        dest="replace",
        action="store_false",
        help="Append to an existing demo2 database instead of replacing it.",
    )
