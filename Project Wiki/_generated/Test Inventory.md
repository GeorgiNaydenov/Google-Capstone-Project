...
| `test_clinical_api.py` | 12 | Frontend contract tests for deterministic clinician product API. |
...
| `test_product_integration.py` | 22 | End-to-end contracts joining the clinical UI API to product state. |
